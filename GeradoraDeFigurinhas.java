...
public class GeradoraDeFigurinhas {
    ...
    public void cria(InputStream inputStream, String nomeArquivo) throws Exception {
        ...
        String frase = "Fantástico";

        // BufferedImage bi = new BufferedImage(1, 1, BufferedImage.TYPE_INT_RGB);
         Graphics g = novaImagem.getGraphics();
         int larguraFrase = g.getFontMetrics().stringWidth(frase);
         
         //int novoX =  (largura - larguraFrase)/2;
         int novoX = (largura / 2) - (larguraFrase * 3) ;
         
         graphics.drawString(frase, novoX, novaAltura - 80);
